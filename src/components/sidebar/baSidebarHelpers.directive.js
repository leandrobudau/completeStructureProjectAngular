app.directive('baSidebarToggleMenu', function baSidebarToggleMenu (baSidebarService) {
  return {
    restrict: 'A',
...
app.directive('baSidebarCollapseMenu', function baSidebarCollapseMenu (baSidebarService) {
  return {
    restrict: 'A',
    link: function (scope, elem) {
      elem.on('click', function ($evt) {
...
app.directive('baSidebarTogglingItem', function baSidebarTogglingItem () {
  return {
    restrict: 'A',
    controller: 'BaSidebarTogglingItemCtrl'
  }
})
app.controller('BaSidebarTogglingItemCtrl', function BaSidebarTogglingItemCtrl ($scope, $element, $attrs, $state, baSidebarService) {
  var vm = this
...
app.directive('baUiSrefTogglingSubmenu', function baUiSrefTogglingSubmenu ($state) {
  return {
    restrict: 'A',
...
app.directive('baUiSrefToggler', function baUiSrefToggler (baSidebarService) {
  return {
    restrict: 'A',
    require: '^baSidebarTogglingItem',
    link: function (scope, el, attrs, baSidebarTogglingItem) {
